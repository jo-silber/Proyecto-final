  ...
  if (catID) {
    ...
    getJSONData(productsURL).then(function (resultObj) {
      if (resultObj.status === "ok") {
        ...
        // == por precio ==
        document
          .getElementById("filtrarPrecio")
          .addEventListener("click", () => {
            let precioMin = parseInt(
              document.getElementById("precioMin").value
            );
            let precioMax = parseInt(
        ...
        // == precio ascendiente ==
        document
          .getElementById("filtrarPrecioAsc")
          .addEventListener("click", () => {
            let filtrarProductos = [...productsArray].sort(
              (a, b) => a.cost - b.cost
            );
        ...
        document
          .getElementById("filtrarPrecioDesc")
          .addEventListener("click", () => {
            let filtrarProductos = [...productsArray].sort(
              (a, b) => b.cost - a.cost
            );
        ...
        document
          .getElementById("filtrarPorRelevancia")
          .addEventListener("click", () => {
            let filtrarProductos = [...productsArray].sort(
        ...
        console.error(
          "No se encontró ningún catID en el almacenamiento local."
        );
      }
    });
